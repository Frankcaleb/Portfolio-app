  ...
  return (
    <div className='px-3 py-10 md:px-20 rounded-b-4xl bg-white font-quicksand'>
      <motion.div
        ...
        <p className=' text-justify my-5 md:text-center md:mx-44 '>I'm a frontend developer with 1 year of experience, I create webpage interface that enhance user experience. I use tools like react, js and tailwind to develop user interface
